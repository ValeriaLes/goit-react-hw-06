...
export default function ContactForm ({onSubmit}) {
    ...
    return (
        <>
        <Formik initialValues={initialValues} onSubmit={handleSubmit} validationSchema={ContactForm}>
            <Form className={css.form}>
              ...
              <Field name="number" type="number" id={numberFieldId} className={css.field}/>
